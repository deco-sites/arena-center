...
function Suggestions(
  ...
  return (
    ...
    >
      <div class="gap-4 grid grid-cols-1 sm:grid-cols-[150px_1fr] sm:grid-rows-1">
        ...
        <div class="flex flex-col gap-6 pt-6 md:pt-0 overflow-x-hidden">
          <span class="font-medium text-xl" role="heading" aria-level={3}>
            Produtos sugeridos
          </span>
          <Slider class="carousel">
            {products?.map((product, index) => (
              <Slider.Item
                index={index}
                class="last:mr-4 first:ml-4 min-w-[200px] max-w-[200px] carousel-item"
              >
                <ProductCard
                  product={product}
                  index={index}
