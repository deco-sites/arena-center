...
const gradeButtonsClick = (itemsPerLine: 2 | 3 | 4, id: string) => {
    ...
    Array.from(childrenDivs).forEach((item) => (item as HTMLElement).style.width = largura);
};
    ...
    return (<div>
      <div class="flex justify-end">
        <button class="p-8" hx-on:click={useScript(gradeButtonsClick, 2, id)}>
          <Image src={props.buttons[0].icone} width={15} height={15}/>
        </button>
        <button class="p-8" hx-on:click={useScript(gradeButtonsClick, 3, id)}>
          <Image src={props.buttons[1].icone} width={15} height={15}/>
        </button>
        <button class="p-8" hx-on:click={useScript(gradeButtonsClick, 4, id)}>
          <Image src={props.buttons[2].icone} width={15} height={15}/>
        </button>
      </div>
      <div class="flex flex-wrap justify-center items-center" id={id}>
        <div class="px-8">
          <Image class="w-full" src={props.img} width={600} height={600}/>
        </div>
        <div class="px-8">
          <Image class="w-full" src={props.img} width={600} height={600}/>
        </div>
