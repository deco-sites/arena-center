  ...
  return (
    <div class="mx-auto max-w-[1440px] flex flex-col gap-2 mt-8 px-0 md:px-6">
      ...
      >
        ...
        <div class="relative bottom-[15%] z-10 col-span-1 col-start-1 row-span-1 mt-9 row-start-1 p-2 self-center">
        ...
        <div class="relative bottom-[15%] z-10 col-span-1 col-start-3 row-span-1  mt-9 row-start-1 p-2 self-center">
